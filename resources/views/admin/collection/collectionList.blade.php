            ...
            <div class="nav-search" id="nav-search">
                <form action="" method="get" class="form-search">
                    <select name="type" id="form-field-1" class="searchtype">
                        {{--<option value="1">专家课程</option>--}}
                        {{--<option value="2">点评课程</option>--}}
                        <option value="3">专家课程名称</option>
                        <option value="4">点评课程名称</option>
                        <option value="5">收藏用户</option>
                        <option value="6">时间筛选</option>

    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="{{url('/admin/commentReply/applyCommentList')}}">评论回复管理</a>
                </li>
                <li class="active">视频点评评论列表</li>
            </ul><!-- .breadcrumb -->
                        ...
                        <div class="table-responsive">
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                ...
                                @foreach($data as $apply)
                                    ...
                                    <tr>
                                        <td>{{$apply->id}}</td>
                                        <td class="commentContentjs">{{$apply->commentContent}}</td>
...
//        }
        ...
        function courseChecks(id,checks){
            ...
            $.ajax({
                ...
                url: "/admin/commentReply/applyCommentChecks",

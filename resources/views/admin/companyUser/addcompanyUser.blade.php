                ...
                <div class="col-xs-12">
                    ...
                    <form action="{{url('admin/companyUser/addscompanyUser')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input  type="text" name="username" id="form-field-1" placeholder="用户名" class="col-xs-10 col-sm-5" value="" />
                                    <span class="help-inline col-xs-12 col-sm-7">
                                    <label class="middle">
                                        <span class="lbl"></span>
                                        <span style="position:relative;top:5px;font-size:10px;color:#A9A9A9" >4—16位字母(不区分大小写)汉字/数字/下划线</span>
                                    </label>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input  type="text" name="realname" id="form-field-1" placeholder="真实姓名" class="col-xs-10 col-sm-5" value="" />
                                    <span class="help-inline col-xs-12 col-sm-7">
                                    <label class="middle">
                                        <span class="lbl"></span>
                                    </label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input  type="password" name="password" id="form-field-1" placeholder="密码" class="col-xs-10 col-sm-5" value="" />
                                    ...
                                    <label class="middle">
                                        <span class="lbl"></span>
                                        <span style="position:relative;top:5px;font-size:10px;color:#A9A9A9">6—16位字母/数字</span>
                                    </label>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input  type="text" id="phone"  name="phone" id="form-field-1" placeholder="电话" class="col-xs-10 col-sm-5" value="" />
                                    <span class="help-inline col-xs-12 col-sm-7">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input  type="text"  id="email" name="email" id="form-field-1" placeholder="邮箱" class="col-xs-10 col-sm-5" value="" />
                                    <span class="help-inline col-xs-12 col-sm-7">
                                    <label class="middle">
                                        <span class="lbl"></span>

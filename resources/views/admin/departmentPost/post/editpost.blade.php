        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form action="{{url('admin/departmentPost/editspost')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-9">
                                <select name="depart" id="depart" class="col-xs-10 col-sm-5" style="width:120px">
                                    ...
                                    @foreach($depart as $depart)
                                        <option value="{{$depart->id}}" @if($data->parentId == $depart->id) selected @endif >{{$depart->departName}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input  type="text" name="postName" id="form-field-1" placeholder="岗位名称" class="col-xs-10 col-sm-5" value="{{$data->postName}}" />
                                    <span class="help-inline col-xs-12 col-sm-7">
                                    <label class="middle">
                                        <span class="lbl"></span>
                                    </label>

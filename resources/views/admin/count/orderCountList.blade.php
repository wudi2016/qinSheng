    ...
    <div class="main-content" ms-controller="specialcommentdetail">
        ...
        <div class="page-content">
            ...
            <form action="{{url('admin/excel/userCountExport')}}" method="post">
                <input type="submit" class="btn btn-xs btn-info"  value="导出订单数" style="width:86px; cursor: pointer;" />
                {{csrf_field()}}
...
@endsection
@section('js')
    <script type="text/javascript" src="{{asset('admin/js/count/orderCount.js')}}"></script>
@endsection

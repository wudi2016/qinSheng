    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" role="form" method="post" action="{{url('admin/users/insert')}}" onsubmit=" return postcheck();">
                        {{csrf_field()}}
                        ...
                        {{--邀请码--}}
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-4">邀请码</label>
                        ...
                        <div class="form-group hide  hide_teacher">
                            ...
                            <div class="col-sm-9">
                                <input class="col-xs-10 col-sm-4" name="school" type="text" id="form-field-4"
                                       placeholder="毕业院校" value="{{old('school')}}"/><span
                                        style="display: block;height:30px;line-height: 30px;color:brown;"></span>
                                <div class="space-2"></div>
                            </div>
                        </div>
                        ...
                        <div class="form-group hide  hide_student">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">生日<small>(年-月-日)</small></label>

                            <div class="col-sm-9">

                                <select id="sel_year" class="col-xs-10 col-sm-2" name="birthYear"></select>
                                <select id="sel_month" class="col-xs-10 col-sm-1" name="birthMonth"></select>
                                <select id="sel_day" class="col-xs-10 col-sm-1" name="birthDay"></select>
                        ...
                        <div class="form-group hide hide_student">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">开始学琴时间<small>(年-月)</small></label>

                            <div class="col-sm-9">
                                <select  class="sel_year col-xs-10 col-sm-2" name="learnYear"></select>
                                <select  class="sel_month col-xs-10 col-sm-2" name="learnMonth"></select>
                            <span class="help-inline col-xs-12 col-sm-7">
                            <span class="middle"></span>
                            </span>
                            </div>

    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="{{url('/admin/users/userList')}}">名师管理</a>
                </li>
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" role="form" method="post" action="{{url('admin/users/doEditFamousTeacher')}}" onsubmit=" return postcheck();" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text"  id="form-field-1" name="id" placeholder="id" class="col-xs-10 col-sm-4" value="{{$data->id}}" readonly/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input class="col-xs-10 col-sm-4" disabled type="hidden" name="originalphone" id="form-field-4" placeholder="Phone" value="{{$data->phone}}"/>
                                <input class="col-xs-10 col-sm-4" type="text" name="phone" id="form-field-4" placeholder="Phone" value="{{$data->phone}}"/>
                                <span style="display: block;height:30px;line-height: 30px;color:brown;"></span>
                    ...
                    @if($data->type == 2)
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input class="col-xs-10 col-sm-4" name="price" type="text" id="form-field-4" placeholder="价格" value="{{$data->teacherinfo->price}}"/><span
                                            style="display: block;height:30px;line-height: 30px;color:brown;"></span>
                                    <div class="space-2"></div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input class="col-xs-10 col-sm-4" name="stock" type="text" id="form-field-4" placeholder="点评名额" value="{{$data->teacherinfo->stock}}"/><span
                                            style="display: block;height:30px;line-height: 30px;color:brown;"></span>
                                    <div class="space-2"></div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <select name="firstletter" id="form-field-2" class="col-xs-10 col-sm-2">
                                        @foreach($letter as $key=>$letters)
                                            <option value="{{$letters}}" @if($letters == $data->teacherinfo->firstletter) selected @endif>{{$letters}}</option>
                                        @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <img src="{{asset($data->teacherinfo->cover)}}" id="uploadPreview" class="col-xs-10 col-sm-5" onerror="this.src='/admin/image/back.png'"/>
                            <span class="help-inline col-xs-12 col-sm-7">
                                <label class="middle">
                                    <span class="lbl"></span>
                                </label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea  class="col-xs-10 col-sm-5" style="resize:none" name="intro" id="" cols="30" rows="10">{{$data->teacherinfo->intro}}</textarea>
                                    <div class="space-2"></div>
                                </div>
                            </div>
        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                $("input[name='phone']").blur(function () {
                    var obj = $(this);
                    var phone = obj.val();
                    var original = $("input[name='originalphone']").val();//获取原来的手机号
                    if(original != phone){

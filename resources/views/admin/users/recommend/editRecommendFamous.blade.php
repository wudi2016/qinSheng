        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form action="{{url('admin/users/doEditRecommendFamous')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" readonly name="teacher" id="form-field-1" placeholder="名师" class="col-xs-10 col-sm-5" value="{{$data->teacher}}" />
                                <input type="hidden"  name="teacherId" id="form-field-1" placeholder="名师" class="col-xs-10 col-sm-5" value="{{$data->teacherId}}" />

...
@section('content')
    <div class="main-content" ms-controller="specialcommentdetail">
            ...
            {{--<div class="nav-search" id="nav-search">--}}
                {{--<form action="{{url('/admin/specialCourse/specialCourseList')}}" method="get" class="form-search">--}}
                    {{--<select name="type" id="form-field-1" class="searchtype">--}}
                        ...
                        {{--<option value="5" @if($data->type == 4) selected @endif>时间筛选</option>--}}
        ...
        <div class="page-content">
            ...
            <a href="{{url('/admin/specialCourse/addSpecialType')}}" class="btn btn-xs btn-info">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                    ...
                                                    <a href="{{url('/admin/specialCourse/editSpecialType/'.$type->id)}}" class="btn btn-xs btn-info">

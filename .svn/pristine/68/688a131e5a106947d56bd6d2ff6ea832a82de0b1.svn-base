        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form action="{{url('admin/specialCourse/doEditData')}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="dataName" id="form-field-1" placeholder="资料名称" class="col-xs-10 col-sm-5" value="{{$data->dataName}}" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="hidden" name="organurl" value="{{$data->dataPath}}">
